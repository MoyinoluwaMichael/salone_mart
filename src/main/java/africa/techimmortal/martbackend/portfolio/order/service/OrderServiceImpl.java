...
import africa.techimmortal.martbackend.portfolio.order.domain.model.Order;
import africa.techimmortal.martbackend.portfolio.order.domain.model.ProductOrder;
import africa.techimmortal.martbackend.portfolio.order.domain.repository.OrderRepository;
...
import static africa.techimmortal.martbackend.core.utils.Message.ORDER_WITH_ID_NOT_FOUND;
import static africa.techimmortal.martbackend.core.utils.AppUtils.CANCEL;
import static africa.techimmortal.martbackend.core.utils.AppUtils.CHECKOUT;
import static africa.techimmortal.martbackend.core.utils.AppUtils.COMPLETE;
import static africa.techimmortal.martbackend.core.utils.AppUtils.DELIVER;
import static africa.techimmortal.martbackend.core.utils.AppUtils.IN_TRANSIT;
        ...
        order.setProductOrders(
                orderCreationRequest.getProductOrders()
                        ...
                        .map(productOrderCreationRequest -> {
                            ...
                            productOrder.setVendorId(product.getVendorId());
                            productOrder.setPrice(product.getPrice());
                            productOrder.setTotalAmount(product.getPrice().multiply(BigDecimal.valueOf(productOrderCreationRequest.getQuantity())));
                            return productOrder;
                        })
