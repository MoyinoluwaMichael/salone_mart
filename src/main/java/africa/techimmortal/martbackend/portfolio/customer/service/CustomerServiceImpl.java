...
import africa.techimmortal.martbackend.portfolio.customer.domain.repository.CustomerRepository;
...
import static africa.techimmortal.martbackend.core.utils.AppUtils.EMAIL_VALUE;
import static africa.techimmortal.martbackend.core.utils.AppUtils.PHONE_NUMBER;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    private CustomerListingDto getCustomerListingDto(Page<Customer> pagedCustomers) {
        Page<CustomerResponseDto> customerResponseDtoPage = pagedCustomers.map((customer) -> {
            try {
                return martMapper.readValue(customer, CustomerResponseDto.class);
